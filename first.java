...
public class first {
    public static void main(String[] args) {
        ...
        if (authenticateUser(username, password)) {
            ...
            // Reservation
            boolean reservationSuccess = performReservation(userDetails, trainNumber, classType, dateOfJourney,
    ...
    private static boolean authenticateUser(String username, String password) {
        ...
        String storedUsername = "Faizan";
        String storedPassword = "Pass@123";

        return username.equals(storedUsername) && password.equals(storedPassword);
    }

    private static boolean performReservation(String userDetails, int trainNumber, String classType,
            String dateOfJourney, String sourceStation, String destinationStation) {
